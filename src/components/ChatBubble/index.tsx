export default function ChatBubble() {
  return (
    <div className="flex pb-6 opacity-80 z-10">
      <div className="relative bg-gray-200 rounded-lg text-black font-bold text-center break-words px-13 py-4 max-w-xs border-4 border-black shadow-[4px_4px_0px_#000] self-end">
        픽셀 픽셀
